...
def get_tweet_training_data():
	f = open(r"/Users/anmolagarwal/Desktop/Tweet Classification/training.txt")
	training_data = []
...
def get_tweet_test_data():
	f = open(r"/Users/anmolagarwal/Desktop/Tweet Classification/test.txt")
	validation_data = []
	for l in f.readlines():
		l = l.strip()
		tweet_details = l.split(' ')
...
def print_labelled_data(labels):
	f_out = open('/Users/anmolagarwal/Desktop/Tweet Classification/Output.txt', 'w')  
